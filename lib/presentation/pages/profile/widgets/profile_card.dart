...
class ProfileCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const String userEmail = "nguyenvana@example.com";
    const String avatarUrl = "https://via.placeholder.com/100"; // Replace with actual URL
    const double moneyRemain = 5000000; // 5 triệu VND
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: isDarkMode ? Colors.white : Color(0xFF303952),
                    letterSpacing: 0.3,
                  ),
                ),
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: isDarkMode ? Colors.green[800]!.withOpacity(0.3) : Colors.white.withOpacity(0.6),
                    shape: BoxShape.circle,
                  ),
                  child: Icon(
